...
def main():
    input_string = """kAewtloYgcFQaJNhHVGxXDiQmzjfcpYbzxlWrVcqsmUbCunkfxZWDZjUZMiGqhRRiUvGmYmvnJIHEmbT
    ...
    print(p.findall(input_string))
    """<_sre.SRE_Match object; span=(51, 58), match='WDZjUZM'>"""
